...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "micaela@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve swimming skills and participate in relays",
    ...
    "Science Club": {
        "description": "Run experiments and explore scientific topics together",
